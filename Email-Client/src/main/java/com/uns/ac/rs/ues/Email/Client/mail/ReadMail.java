...
import com.uns.ac.rs.ues.Email.Client.util.DateUtil;
...
private static String DATA_DIR_PATH;
		...
		public static void receiveEmail(String pop3Host, String storeType,  Account account,GregorianCalendar maxDateTime,long count,String folder,MyMessageService messageService) throws ParseException  {  
			
			Message[] messages;	
			String password=proveraPassworda(account.getPassword());
				
			System.out.println("Lozinka za nalog je <------------------------>\n" + password);
				...
				Properties properties = new Properties(); 
					...
					Session emailSession = Session.getDefaultInstance(properties,
						...
						protected javax.mail.PasswordAuthentication getPasswordAuthentication() {
							return new javax.mail.PasswordAuthentication(account.getUsername(),password);
						}
					}); 
		    ...
		    message.setToReciver(to);
		    message.setCcReciver(cc);
		    message.setBccReciver(bcc);
